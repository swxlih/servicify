...
class TechnicianRegister extends StatefulWidget {
  const TechnicianRegister({super.key});

  @override
  State<TechnicianRegister> createState() => _TechnicianRegisterState();
}
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 30,),
                Text("Register Technician here...",style: TextStyle(color: primaryColor,fontSize: 24,fontWeight: FontWeight.bold),),
